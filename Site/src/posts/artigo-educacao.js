const post = {
    ...
    content: [{img: {
        ...
        {p: "Segundo a pesquisadora, essa construção atravessa gerações. As feministas inglesas, por exemplo, já demonstraram como se estabeleceu uma relação entre tecnologia e masculinidade historicamente."},
